...
var updateContentPane = new Array();
...
{
   if(updateContentPane[page.id] != null)
   {
        updateContentPane[page.id]();
   }
...
function submitForm(form)
{
    ...
    if (iui.DialogCallbackOnSubmit != undefined )
    {
        iui.DialogCallbackOnSubmit();
    }
}
